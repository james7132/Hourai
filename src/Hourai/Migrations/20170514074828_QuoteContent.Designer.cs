...
namespace Hourai.Migrations
{
    ...
    [Migration("20170514074828_QuoteContent")]
    partial class QuoteContent
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Hourai.Model.CustomConfig", b =>
                {
                    b.Property<ulong>("GuildId");
            ...
            modelBuilder.Entity("Hourai.Model.TempDeafen", b =>
                {
                    b.HasBaseType("Hourai.Model.AbstractTempAction");
                    ...
                    b.HasDiscriminator().HasValue("TempDeafen");
                });

            modelBuilder.Entity("Hourai.Model.TempMute", b =>
                {
                    b.HasBaseType("Hourai.Model.AbstractTempAction");
                    ...
                    b.HasDiscriminator().HasValue("TempMute");
                });
